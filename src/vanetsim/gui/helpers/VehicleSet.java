...
public class VehicleSet {
    ...
    public void setData(int vehicleLength, int minSpeed, int maxSpeed, int minCommDist, int maxCommDist, int minWait, int maxWait, int minBraking, int maxBraking, int minAcceleration, int maxAcceleration, int minTimeDistance, int maxTimeDistance, int minPoliteness, int maxPoliteness, int wiFi, int emergencyVehicle, int fakingVehicle, String fakeMessagesTypes, int amount, int speedStreetRestriction, int vehiclesDeviatingMaxSpeed, int deviationFromSpeedLimit, Color color) {
    ...
    public int getWiFi_() {
        //System.out.println("VehicleSet.java wiFi_="+wiFi_);
        return wiFi_;
