...
public final class LocationInformationLogWriter {
    ...
    private static Logger logger = Logger.getLogger("LocationInformationLog");
        ...
        try {
            if (!dir.equals(logOldPath)) {
                ...
                if (scenName != null && !scenName.equals(""))
                    handler = new FileHandler(dir + "LocationInformationLog_" + scenName.substring(0, scenName.length() - 4) + "_" + df.format(dt) + "." + format, true);
                else
                    handler = new FileHandler(dir + "LocationInformationLog_" + df.format(dt) + "." + format, true);
                logOldPath = dir;
